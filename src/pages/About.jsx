...
const About = () => {
  ...
  const values = [
    ...
    {
      title: "Accurate",
      description: "Our advanced AI technology delivers 99.7% accuracy by intelligently optimizing performance for enterprise-grade applications.",
      icon: "🎯"
    }
  ];
  ...
  const team = [
    ...
    },
    {
      ...
      role: "CTO & Co-Founder",
      bio: "Ex-Meta AI Research Director, pioneered transformer architecture innovations. Leads our AI platform development.",
      image: "👨‍💻"
    },
    {
      name: "Alex Rodriguez",
    ...
    },
    {
      name: "Jennifer Walsh",
      role: "VP of Security",
      bio: "Former CISO at major financial institutions. Ensures Quanta meets the highest security and compliance standards.",
      image: "👩‍🔒"
    }
  ];
  ...
  const milestones = [
    {
      year: "2023",
      title: "Founded",
      description: "Quanta was founded with the vision of creating the world's first Universal AI Employee"
    },
    {
      year: "2023",
      title: "Seed Funding",
    ...
    },
    {
      year: "2024",
              ...
              description: "Released our advanced AI platform achieving 99.7% accuracy across enterprise workflows"
    },
    {
      year: "2024",
      ...
      <div className="pt-[12rem] -mt-[5.25rem]">
        ...
        <div className="container">
            ...
            >
              ...
              <h1 className="h1 mb-6">About Quanta</h1>
          ...
          <div className="mb-20">
            ...
            {/* Timeline */}
          {/* <div className="mb-20">
              <Heading title="Our Journey" text="Key milestones in Quanta's evolution" />
            ...
            {/* Team */}
          {/* <div className="mb-20">
              <Heading title="Leadership Team" text="The visionaries behind Quanta's AI revolution" />
            ...
            >
              ...
              <p className="text-lg text-n-3 mb-8 max-w-2xl mx-auto">
                Experience the future of work with Quanta. Deploy your first AI employee in minutes 
                and transform your business operations forever.
              </p>
              <div className="flex justify-center gap-4">
                <Button>Hire Quanta Today</Button>
