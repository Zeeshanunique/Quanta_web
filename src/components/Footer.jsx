...
const Footer = () => {
  ...
  const footerLinks = [
    ...
    },
    {
      title: "Platform",
      links: [
        { title: "Features", url: "/product#features" },
        { title: "Pricing", url: "/product#pricing" },
        { title: "Demo", url: "/contact" },
        { title: "Templates", url: "/product#templates" }
      ]
    },
    {
      title: "Services",
      links: [
        { title: "Consulting", url: "/services" },
        { title: "Training", url: "/services" },
        { title: "Custom Development", url: "/services" },
        { title: "Compliance Advisory", url: "/services" }
      ]
    }
  ];
  ...
  const socialLinks = [
    { 
      ...
      url: "https://twitter.com/Zeeshan_uni" 
    },
    { 
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
