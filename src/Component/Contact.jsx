...
function Contact() {
  ...
  const onSubmit = async (event) => {
    ...
    if (data.success) {
      ...
      setShowImage(true); // Add this line
      event.target.reset();
    } else {
      console.log("Error", data);
      setResult("Somthing Went Wrong "+data.message);
    }
  };
  ...
  return (
    <Sections id="contact">
      ...
      <section class="body-font relative bg-gray-900/20 text-gray-400 w-[65%] rounded-[25px] mx-auto border border-gray-700 shadow-purple-900">
...
<div class="container  mx-auto px-5 py-24">
  ...
  <div class="mb-12 flex w-full flex-col text-center">
    <h1 class="title-font mb-4 text-2xl font-medium text-white sm:text-3xl h1">Request a Demo</h1>
    <p class="mx-auto text-base leading-relaxed lg:w-2/3">Experience how our AI automation platform can transform your business with high-accuracy agents and user-friendly solutions.</p>
  </div>

  <form onSubmit={onSubmit}>
  <div class="mx-auto md:w-2/3 lg:w-1/">
    <div class="-m-2 flex flex-wrap">
      ...
      <div class="w-full p-2">
        <button type='submit' class="mx-auto flex rounded  focus:outline-none "><Button white>Send</Button></button>
      </div>
...
<div className='text-center'><h3>{result}</h3></div>
